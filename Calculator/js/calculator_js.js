...
function Input_Digit(digit) {
    ...
    //This checks is the Wait_Second_Operand is true and sets Display_Value
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Value does not contain a decimal point we want to add
        // a decimal point.
...
function Handle_Operator(Next_Operator) {
    ...
    /* Checks is an operator already exists and if Wait_Second_Operand is true, then
...
function Update_Display() {
    //Makes use of calculator-screen class to target input tag in the doc
